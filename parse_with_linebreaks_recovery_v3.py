...
def extract_picture_text_lines(doc_dict: dict, picture_ref: str) -> List[str]:
    """
...
def remove_repeated_from_markdown(
    ...
    while i < len(in_lines):
        ...
        if line.strip() == image_marker:
            ...
            # Optionally inject picture-associated text (e.g. Docling OCR) right after the marker.
            ...
            if include_image_text and pic_ref and pic_ref not in first_occurrence_refs:
                extracted = extract_picture_text_lines(doc_dict, pic_ref)

                # Only inject if it doesn't already appear immediately after this marker
